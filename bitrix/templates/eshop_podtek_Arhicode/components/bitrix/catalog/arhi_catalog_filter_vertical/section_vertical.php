...
<div class="<?= (($isFilter || $isSidebar) ? "col-md-9 col-sm-8" : "col-xs-12") ?> tmv-m">
    <div class="row">
        <div class="col-xs-12">
            <?
        ...
        <div class="col-xs-12">
            ...
            $arSortFields = array(
                ...
                "NAME_ARC" => array( // параметр в url
                    ...
                    "CODE" => "SHOWS", // Код поля для сортировки
                    "NAME" => GetMessage("CATALOG_SORT_FIELD_SHOWS_ASC") // имя для вывода в публичной части, редактировать в (/lang/ru/section.php)
                ),
                "NAME_DESC" => array( // параметр в url
                    "ORDER" => "DESC", //в возрастающем порядке
                    "CODE" => "SHOWS", // Код поля для сортировки
                    "NAME" => GetMessage("CATALOG_SORT_FIELD_SHOWS_DESC") // имя для вывода в публичной части, редактировать в (/lang/ru/section.php)
                ),
                "PRICE_ASC" => array(
                    "ORDER" => "ASC",
                        ...
                        <div class="sortFields" id="selectSortParams">
                            <div class="dropdown">
                                <button class="btn sv-view-n dropdown-toggle" type="button" data-toggle="dropdown">
                                    <?= GetMessage("CATALOG_SORT_LABEL");
                                    echo ' ' . $arSortFields[$_REQUEST["SORT_FIELD"]]["NAME"]; ?>
                                    <span class="caret"></span></button>
                                <ul class="dropdown-menu">

                                    <? foreach ($arSortFields as $arSortFieldCode => $arSortField): ?>
                                        <li class="element">
                                            <a<? if ($arSortField["SELECTED"] != "Y"): ?> href="<?= $APPLICATION->GetCurPageParam("SORT_FIELD=" . $arSortFieldCode, array("SORT_FIELD")); ?>"<? endif; ?>
                                                    class="<? if ($arSortField["SELECTED"] == "Y"): ?>selected<? endif; ?>"><?= $arSortField["NAME"] ?></a>
                                        </li>
                                    <? endforeach; ?>
                                </ul>
                            </div>
                    ...
                    <div class="column">
                        ...
                        <div class="countElements" id="selectCountElements">
                            ...
                            <div class="dropdown">
                                <button class="btn sv-view-n dropdown-toggle" type="button" data-toggle="dropdown">
                                    <?= GetMessage("CATALOG_SORT_TO_LABEL");
                                    echo ' ' . $_REQUEST["SORT_TO"]; ?>
                                    <span class="caret"></span></button>
                                <ul class="dropdown-menu">

                                    <? foreach ($arSortProductNumber as $arSortNumberElementId => $arSortNumberElement): ?>
                                        <li class="element">
                                            <a<? if ($arSortNumberElement["SELECTED"] != "Y"): ?> href="<?= $APPLICATION->GetCurPageParam("SORT_TO=" . $arSortNumberElementId, array("SORT_TO")); ?>"<? endif; ?>
                                                    class="<? if ($arSortNumberElement["SELECTED"] == "Y"): ?>selected<? endif; ?>"><?= $arSortNumberElementId ?></a>
                                        </li>
                                    <? endforeach; ?>
                                </ul>
                            </div>
