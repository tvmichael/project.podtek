		...
		<div class="row">
			...
			<div class="col-md-8 col-sm-12">
				<div class="row">
					<div class="col-sm-7">
						<div class="col-xs-12">
							<h1 class="bx-title" style = "display: none;"><?=$name?></h1>
							<h4 class="bx-title"><?=$name?></h4>
							<h5 class="bx-code"><span>код товара: </span><?=$arResult['PROPERTIES']['CML2_ARTICLE']['VALUE']?></h5>
							...
							?-->
<!--?if($USER->IsAdmin()) {echo '<pre>'; print_r($arResult['PREVIEW_TEXT']); echo '</pre>';}?-->
						</div>
...
<!-------------price--------------->
						<div class="col-xs-12 product-item-detail-pay-block">
							<?
...
<!-------------quantity--------------->
						<div class="col-xs-12 col-sm-4 product-item-detail-pay-block_1">
							<?
							foreach ($arParams['PRODUCT_PAY_BLOCK_ORDER'] as $blockName)
							{
								switch ($blockName)
