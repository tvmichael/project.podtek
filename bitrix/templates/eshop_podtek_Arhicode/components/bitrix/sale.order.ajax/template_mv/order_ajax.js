...
(function() {
	...
	BX.Sale.OrderAjaxComponent = {
		...
		show: function(node)
		{
			...
			switch (node.id)
			{
				...
				case this.basketBlockNode.id:
					...
					break;
				case this.regionBlockNode.id:
					this.editActiveRegionBlock(true);	// регіон-місто-індкс...
					break;
				case this.deliveryBlockNode.id:
		...
		editActiveRegionBlock: function(activeNodeMode) // регіон-місто-нндекс...
		{
			...
			{
				console.log('  editActiveRegionBlock: initialized.region-fasle');
		...
		editFadeRegionBlock: function() // регіон-місто-індекс...
		{
