...
<div class="product-item">
	...
	<div class="product-item-title">
		<a href="<?=$item['DETAIL_PAGE_URL']?>" title="<?=$productTitle?>" onclick="return true;" data-click="off"><?=$productTitle?></a>
	</div>
	<?
			...
			switch ($blockName)
			{
				case 'price': ?>
					<div class="product-item-info-container product-item-price-container" data-entity="price-block">
						...
						{
						?>			
						<span class="product-item-price-current1" id="<?=$itemIds['PRICE']?>">
						<?}else{?>
				...
				case 'quantity':
						...
						if ($actualItem['CAN_BUY'] && $arParams['USE_PRODUCT_QUANTITY'])
						{
							...
							<div class="product-item-info-container product-item-hidden" data-entity="quantity-block">
								<div class="product-item-amount_1">
									<div class="product-item-amount-field-container_3">
					...
					elseif ($arParams['PRODUCT_DISPLAY_MODE'] === 'Y')
					{
						if ($arParams['USE_PRODUCT_QUANTITY'])
						{
							...
							<div class="product-item-info-container product-item-hidden" data-entity="quantity-block">
								<div class="product-item-amount_1">
									<div class="product-item-amount-field-container_4">
										<span class="product-item-amount-field-btn-minus no-select" id="<?=$itemIds['QUANTITY_DOWN']?>"></span>
										<input class="product-item-amount-field" id="<?=$itemIds['QUANTITY']?>" type="number"
											name="<?=$arParams['PRODUCT_QUANTITY_VARIABLE']?>"
											value="<?=$measureRatio?>">
