...
<?
/***** додаємо канонікал для пагінації  ***/

	if (substr_count($_SERVER['REQUEST_URI'], "PAGEN_1=")>0) {
		$pageCanonikal = '<link rel="canonical" href="';
		if ($_SERVER["HTTP_X_FORWARDED_PROTO"]='https'){	$pageCanonikal .= $_SERVER["HTTP_X_FORWARDED_PROTO"];
		}else{
			$pageCanonikal .= "http";
		}
		
		$pageCanonikal .= '://';
		$pageCanonikal .= $_SERVER["SERVER_NAME"];
		$pageCanonikal .= $APPLICATION->GetCurPage(false);
		$pageCanonikal .= '" />';
		echo $pageCanonikal;
		
	}
	//echo '<pre> $arCurSection </br>'; print_r($_SERVER); echo '</pre>';
...
<div class="bx-wrapper" id="bx_eshop_wrap">
        ...
        <div class="row bx-header-TopRow">
            <div class="container bx-header-1st-row">
				...
				<? $APPLICATION->IncludeComponent(
					...
					array(
						"ROOT_MENU_TYPE" => "top".$admTemplate,
						"MENU_CACHE_TYPE" => "A",
	...
	array(
		...
		"PATH_TO_PROFILE" => SITE_DIR."personal/order/",
		"COMPONENT_TEMPLATE" => "arhi.basket.line_adm",
	...
	false
            ...
            <div class="row bx-header-BottomRow">
                ...
                <div class="col-md-9 hidden-xs">
					<? $APPLICATION->IncludeComponent("bitrix:menu", "horizontal_multilevel_top_menu_right", Array(
	"ROOT_MENU_TYPE" => "top_site_adm",//.$admTemplate,	// Тип меню для первого уровня
		...
		"COMPONENT_TEMPLATE" => "horizontal_multilevel_top_menu1",
