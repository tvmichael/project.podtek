...
//Bitrix\Main\Diag\Debug::writeToFile([1=>'test_1.php', 'REQUEST'=>$_REQUEST, 'arResult'=>$arResult], "arResult", "/test/log-f.txt");
?>
...
<table border="0" cellpadding="2" cellspacing="1" style="margin: 15px; width: 100%">
	...
	<tr>
        <td>{$arFilterColNum[5]}</td>
        <td>{$arMyNameFilterItem[5]}</td>
        <td align="center">{$arMyQuantityFilterItem[5]}</td>
        <td>{$arMyFilterPrice[5]}</td>
        <td>{$arMyFilterValueItem[5]}</td>
    </tr>
	<tr>
        <td>{$arFilterColNum[6]}</td>
        <td>{$arMyNameFilterItem[6]}</td>
        <td align="center">{$arMyQuantityFilterItem[6]}</td>
        <td>{$arMyFilterPrice[6]}</td>
        <td>{$arMyFilterValueItem[6]}</td>
    </tr>
